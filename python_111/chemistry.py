...
Teacher: Bro. Codling
Title: 08 Prove Assignment: Dictionaries 

---------------------------------------------------------------------

During this assignment, you will write and test the remaining parts 
of the molar mass calculator that you started writing in the previous 
lesson's prove milestone. When you are finished with this prove 
assignment, your chemistry.py program must contain at least four 
...
def main():
    ...
    molar_mass = compute_molar_mass(symbol_list, table)

    print(f"{molar_mass:.5f} molar_mass/total_mass")
    ...
    print("The name of the chemical formula is: " f"{formula_name}")
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for elements in symbol_quantity_list:
        ...
        mass = element_list[ATOMIC_MASS_INDEX]
